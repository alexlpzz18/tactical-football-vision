...
class TeamClassifier:
    ...
    def __init__(self, n_teams: int = 2):
        ...
        Args:
            ...
            Usamos n_teams + 1 porque incluimos al árbitro.
        """
        self.n_clusters = n_teams + 1
        self.kmeans = None
        self.is_fitted = False

    def _extract_torso_color(self, frame: np.ndarray, bbox: np.ndarray) -> np.ndarray:
        """
    ...
    def fit(self, frame: np.ndarray, detections: sv.Detections) -> None:
        """
        Entrena el clasificador con un solo frame.

        Args:
            frame: frame del vídeo
    ...
    def fit_multiple(self, frames: list, detections_list: list) -> None:
        """
